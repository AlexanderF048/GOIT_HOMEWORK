...
PATH_TO_UNSORTED=Path(fr"{sys.argv[1]}")
    ...
    if PATH.is_dir():
        ...
        for item in PATH.iterdir():
            ...
            if item.suffix in pic_type:                
                ...
                if pic_dir.is_dir()==False:                                      
                    pic_dir.mkdir(parents = True, exist_ok =True)
                    #print("! DIRECTORY WAS CREATED:", pic_dir)                
                #elif pic_dir.is_dir()==True:
        ...
        return print("..........Sorry, you specified a non-existent folder. Please try again...........")
